...
<!-- To see the documentation of each algorithm or set of algorithms shown below, click the 
- [Method of moving asymptotes (MMA) using `NonconvexMMA.jl`](mma.md)
- [Interior point method using `Ipopt.jl`](ipopt.md)
- [`NLopt.jl`](nlopt.md)
- [Augmented Lagrangian algorithm using `Percival.jl`](auglag.md)
- [Mixed integer nonlinear programming using `Juniper.jl` or `Pavito.jl`](minlp.md)
- [Multi-start optimization using `Hyperopt.jl`](hyperopt.md)
- [Surrogate-assited optimization using `NonconvexBayesian.jl`](surrogate.md)
- [Multiple trajectory search using `NonconvexSearch.jl`](mts.md)
- [`Metaheuristics.jl`](metaheuristics.md)
- [NOMAD.jl](nomad.md) -->
